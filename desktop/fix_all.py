"""Rewrites main_window to use minimal styling that actually works."""
...
with open("desktop/windows/main_window.py", "w") as f:
    f.write(main_window)
print("main_window.py rewritten")
